    ...
    public partial class InitilizeDB : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.JobEntity", t => t.Job_Id)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.UserEntity", t => t.CreatedBy_Id)
                .ForeignKey("dbo.UserEntity", t => t.UpdatedBy_Id)
                .ForeignKey("dbo.JobEntity", t => t.Job_Id, cascadeDelete: true)
                .Index(t => t.CreatedBy_Id)
                .Index(t => t.UpdatedBy_Id)
                .Index(t => t.Job_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TriggerBaseEntity", "Job_Id", "dbo.JobEntity");
            DropForeignKey("dbo.TriggerBaseEntity", "CreatedBy_Id", "dbo.UserEntity");
            DropForeignKey("dbo.ServiceEntity", "Job_Id", "dbo.JobEntity");
            ...
            DropIndex("dbo.ServiceEntity", new[] { "Job_Id" });
            ...
            DropIndex("dbo.TriggerBaseEntity", new[] { "Job_Id" });
            DropIndex("dbo.TriggerBaseEntity", new[] { "CreatedBy_Id" });
            DropIndex("dbo.TriggerBaseEntity", new[] { "Code" });
